...
SVGRenderer.prototype = {
	 ...
	 */
	init: function (container, width, height, style, forExport, focusable) {
		var renderer = this,
			loc = location,
			boxWrapper,
			element,
		...
		if(focusable){
			attr(element,'focusable',true);
		}else {
			attr(element,'focusable',false);
		}
		// object properties
		renderer.isSVG = true;
	...
	getContainer: function () {
		...
		chart.renderer =
			optionsChart.forExport ? // force SVG, used for SVG export
				new SVGRenderer(container, chartWidth, chartHeight, optionsChart.style, true, optionsChart.focusable) :
				new Renderer(container, chartWidth, chartHeight, optionsChart.style, undefined, optionsChart.focusable);
